# candidate-workspace-shell Specification

## Purpose

Provides the authenticated, persistent workspace layout and navigation (Upload, Chat, Analysis Results, Action Plan) that every candidate-facing frontend feature is built inside — gating access behind an active session and clearly marking not-yet-built sections as disabled rather than broken.
